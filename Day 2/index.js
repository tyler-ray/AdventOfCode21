...
//FORMATTED DATA
let instructionsTestArr = splitInstructions(instructionsTest);
let instructionsRealArr = splitInstructions(instructionsReal);
...
const doUp = (arr, ind) => { aim -= arr[ind + 1] }
const doDown = (arr, ind) => { aim += arr[ind + 1] }
const doForward = (arr, ind) => {
    hPos += arr[ind + 1]
    depth += aim * arr[ind + 1]
}


const doInstructions = (instructions) => {
